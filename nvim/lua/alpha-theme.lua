...
local header = {
  ...
  val = {
    [[]],
    [[    ____                                   _   __      _         ]],
    [[   / __ )_______  ______ _____ )  _____   / | / /   __(_)___ ___ ]],
    [[  / __  / ___/ / / / __ `/ __ \ // ___/  /  |/ / | / / / __ `__ \]],
    [[ / /_/ / /  / /_/ / /_/ / / / / (__  )  / /|  /| |/ / / / / / / /]],
    [[/_____/_/   \__, /\__,_/_/ /_/ /____/  /_/ |_/ |___/_/_/ /_/ /_/ ]],
    [[           /____/                                                ]],
  },
  opts = {
    position = "center",
...
local buttons = {
  ...
  val = {
    ...
    { type = "padding", val = 1 },
    -- dashboard.button("SPC e", "  Explore", "<cmd>Oil<CR>"),
    dashboard.button("SPC e", "  Explore", "<cmd>Yazi<CR>"),
    dashboard.button("SPC f f", "󰈞  Find file"),
    dashboard.button("SPC f g", "󰊄  Live grep"),
    dashboard.button("SPC f m", "󰃀  Find Mark"),
